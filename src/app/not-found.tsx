...
//     if (!mounted) {
//         return (
//             <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#F5F5F5] to-[#EEEEEE]">
//                 <div className="w-16 h-16 border-4 border-[#183D3D] border-t-transparent rounded-full animate-spin"></div>
//             </div>
//         );
//     }

//     return (
//         <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#F5F5F5] to-[#EEEEEE] relative p-4 overflow-hidden">
//             {/* Background decorative elements */}
//             <div className="absolute top-[-10%] left-[-5%] w-[30%] h-[60%] rounded-[40%] bg-gradient-to-br from-[#183D3D] to-[#2A5F5F] opacity-[0.03] rotate-[-15deg]" />
//             <div className="absolute bottom-[-15%] right-[-10%] w-[40%] h-[70%] rounded-[30%] bg-gradient-to-br from-[#183D3D] to-[#2A5F5F] opacity-[0.05] rotate-[20deg]" />

//             {/* Small decorative dots */}
//             {[...Array(12)].map((_, i) => (
//                 <div
//                     key={i}
//                     className="absolute rounded-full bg-[#183D3D] animate-float"
//                     style={{
...
//                 <div className="h-3 w-full bg-gradient-to-r from-[#183D3D] to-[#2A5F5F] relative overflow-hidden">
//                     {[...Array(20)].map((_, i) => (
//                         <div
//                             key={i}
...
//                             <div className="w-1.5 h-7 bg-[#183D3D] rounded mr-3" />
//                             <span className="text-[#183D3D] text-sm font-semibold uppercase tracking-wider">
//                                 Error
//                             </span>
//                         </div>

//                         <h1 className="text-[5rem] font-extrabold text-[#103030] leading-none relative mb-4">
//                             404
//                             <span className="absolute w-3 h-3 bg-[#183D3D] rounded-full -right-3 top-8" />
//                         </h1>

//                         <h2 className="text-3xl font-semibold text-[#1A2B33] mb-6 relative">
//                             Page Not Found
//                             <span className="block w-14 h-1 bg-gradient-to-r from-[#183D3D] to-[#2A5F5F] rounded mt-3" />
//                         </h2>

//                         <p className="text-lg leading-relaxed text-[#040D12] mb-8 max-w-lg">
...
//                                 size="lg"
//                                 onClick={() => router.back()}
//                                 className="border-2 border-[#183D3D] text-[#183D3D] bg-transparent hover:bg-[#183D3D] hover:text-white min-w-[160px] rounded-xl uppercase font-semibold tracking-wide text-sm transition-all duration-300"
//                             >
...
//                             <Button
//                                 size="lg"
//                                 className="bg-gradient-to-r from-[#183D3D] to-[#2A5F5F] text-white hover:shadow-lg hover:-translate-y-1 min-w-[160px] rounded-xl uppercase font-semibold tracking-wide text-sm transition-all duration-300"
//                                 asChild
//                             >
//                                 <Link href="/">
...
//                         <div className="absolute w-[280px] h-[280px] rounded-full bg-gradient-to-r from-[#F5F5F5] to-[#DCDCDC] z-0" />

//                         {/* Decorative rings */}
//                         <div className="absolute w-[350px] h-[350px] rounded-full border-2 border-dashed border-[#DCDCDC] opacity-60" />
//                         <div className="absolute w-[400px] h-[400px] rounded-full border border-[#DCDCDC] opacity-30" />
...
//                 <CardFooter className="p-6 bg-[#F5F5F5] border-t border-[#DCDCDC] flex flex-wrap justify-between items-center gap-4">
//                     <Alert className="border-none shadow-none bg-transparent p-0 flex items-center">
//                         <Info className="h-4 w-4 text-[#183D3D] mr-2" />
//                         <AlertDescription className="text-[#1A2B33] text-sm">
...
//                         variant="outline"
//                         size="sm"
//                         className="bg-white border-[#DCDCDC] hover:border-[#183D3D] text-[#183D3D] font-medium transition-all duration-200"
//                         asChild
//                     >
//                         <Link href="/contact">
//                             Contact Support
